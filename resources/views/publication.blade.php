...
<li class="user-details deep-orange darken-3">
  <div class="row">
    ...
    <div class="col col s8 m8 l8">
      ...
      <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">{{ Request::is('modules/publication/ipo/submission') ? 'Mrs. Jones' : 'Mr. Foobar' }}<i class="mdi-navigation-arrow-drop-down right"></i></a>
      <p class="user-roal">{{ Request::is('modules/publication/ipo/submission') ? 'IPO' : 'Registrar' }}</p>
    </div>
  </div>
</li>
<li class="no-padding">
  <ul class="collapsible collapsible-accordion">
    <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-drive-file
      "></i> Reports</a>
      <div class="collapsible-body">
        <ul>
          <li><a href="#">Enrollment</a>
          </li>
          <li><a href="#">Graduates</a>
          </li>
          <li><a href="#">Licensure</a>
          </li>
          ...
          <li><a href="#">Administrative Staff</a>
          </li>
        </ul>
      </div>
    </li>
