...
<head>
  ...
  <title>User Login | Tanglaw</title>
...
<body class="teal darken-4">
      ...
      <form class="login-form">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="{{ URL::asset('images/puplogo.png') }}" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">- TANGLAW -<br/>Branches and Campuses</p>
          </div>
        </div>
        ...
        <div class="row">          
          <div class="input-field col s12 m12 l12  login-text">
              <input type="checkbox" id="remember-me" class="checkbox-color"/>
              <label for="remember-me">Remember me</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <a href="{{ url('/modules/executive/vp/dashboard') }}" class="btn waves-effect waves-light col s12 yellow grey-text text-darken-4">Login</a>
          </div>
        </div>
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
              <p class="margin right-align medium-small teal-text text-darken-4"><a href="#">Forgot password?</a></p>
          </div>          
        </div>
  ...
  <script type="text/javascript" src="{{ URL::asset('js/plugins/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('css/style.min.css') }}js/plugins.min.js"></script>
    <!--custom-script.js - Add your own theme custom JS-->
    <script type="text/javascript" src="{{ URL::asset('css/style.min.css') }}js/custom-script.js"></script>
